...
function Schrodinger(gpgpUtility_, xResolution_, length_, dt_)
{
  ...
  this.createProgram = function (gl)
  {
    ...
    fragmentShaderSource = "#ifdef GL_FRAGMENT_PRECISION_HIGH\n"
                         ...
                         + ""
                         + "  gl_FragColor.r =  value.r"
                         + "                     - (texture2D(waveFunction, vTextureCoord+ds).g"
                         + "                                  - 2.0*value.g"
                         + "                                  + texture2D(waveFunction, vTextureCoord-ds).g)/(2.0*(dx*dx))*dt;"
                         + "  gl_FragColor.g =  value.g"
                         + "                     + (texture2D(waveFunction, vTextureCoord+ds).r"
                         + "                                  - 2.0*value.r"
                         + "                                  + texture2D(waveFunction, vTextureCoord-ds).r)/(2.0*(dx*dx))*dt;"
